...
inline fun View.errorbar(builder: ErrorbarBuilder.() -> Unit) =
...
inline fun View.longErrorbar(builder: ErrorbarBuilder.() -> Unit) =
...
inline fun View.indefiniteErrorbar(builder: ErrorbarBuilder.() -> Unit) =
