...
public final class Bannerbar extends BaseTransientBottomBar<Bannerbar> {
    ...
    public static Bannerbar make(
        ...
        final BannerbarContentLayout content =
                (BannerbarContentLayout)
                        inflater.inflate(R.layout.design_layout_bannerbar_include, parent, false);
        ...
        bannerbar.view.setPadding(0, 0, 0, 0);
        bannerbar.view.setBackgroundColor(
                getColorAttr(parent.getContext(), android.R.attr.windowBackground));
        bannerbar.view.setLayoutParams(new ViewGroup.MarginLayoutParams(
    ...
    private BannerbarContentLayout getContentLayout() {
     ...
     */
    @NonNull
    public Bannerbar setBackground(@DrawableRes int resId, @Nullable ImageView.ScaleType scale) {
        final ImageView background = getContentLayout().getBackgroundView();
     ...
     */
    @NonNull
    public Bannerbar setBackground(@DrawableRes int resId) {
     ...
     */
    @NonNull
    public Bannerbar setBackground(@NonNull Uri uri, @Nullable ImageView.ScaleType scale) {
        final ImageView background = getContentLayout().getBackgroundView();
        background.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setBackground(@NonNull Uri uri) {
     ...
     */
    @NonNull
    public Bannerbar setBackground(@NonNull Drawable drawable, @Nullable ImageView.ScaleType scale) {
        final ImageView background = getContentLayout().getBackgroundView();
        background.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setBackground(@NonNull Drawable drawable) {
    ...
    @NonNull
    @RequiresApi(23)
    public Bannerbar setBackground(@NonNull Icon icon, @Nullable ImageView.ScaleType scale) {
        final ImageView background = getContentLayout().getBackgroundView();
        background.setVisibility(View.VISIBLE);
    ...
    @NonNull
    @RequiresApi(23)
    public Bannerbar setBackground(@NonNull Icon icon) {
     ...
     */
    @NonNull
    public Bannerbar setBackground(@NonNull Bitmap bitmap, @Nullable ImageView.ScaleType scale) {
        final ImageView background = getContentLayout().getBackgroundView();
        background.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setBackground(@NonNull Bitmap bitmap) {
    ...
    @NonNull
    @RequiresApi(21)
    public Bannerbar setBackgroundColor(@NonNull ColorStateList tint) {
        final ImageView background = getContentLayout().getBackgroundView();
        background.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setBackgroundColor(@ColorInt int color) {
        final ImageView background = getContentLayout().getBackgroundView();
        background.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setContentMargin(@Px int left, @Px int top, @Px int right, @Px int bottom) {
     ...
     */
    @NonNull
    public Bannerbar setContentMarginLeft(@Px int left) {
        final ViewGroup container = getContentLayout().getContainerView();
     ...
     */
    @NonNull
    public Bannerbar setContentMarginTop(@Px int top) {
        final ViewGroup container = getContentLayout().getContainerView();
     ...
     */
    @NonNull
    public Bannerbar setContentMarginRight(@Px int right) {
        final ViewGroup container = getContentLayout().getContainerView();
     ...
     */
    @NonNull
    public Bannerbar setContentMarginBottom(@Px int bottom) {
        final ViewGroup container = getContentLayout().getContainerView();
     ...
     */
    @NonNull
    public Bannerbar setImage(@DrawableRes int resId) {
        final ImageView image = getContentLayout().getImageView();
     ...
     */
    @NonNull
    public Bannerbar setImage(@NonNull Uri uri) {
        final ImageView image = getContentLayout().getImageView();
        image.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setImage(@NonNull Drawable drawable) {
        final ImageView image = getContentLayout().getImageView();
        image.setVisibility(View.VISIBLE);
    ...
    @NonNull
    @RequiresApi(23)
    public Bannerbar setImage(@NonNull Icon icon) {
        final ImageView image = getContentLayout().getImageView();
        image.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setImage(@NonNull Bitmap bitmap) {
        final ImageView image = getContentLayout().getImageView();
        image.setVisibility(View.VISIBLE);
     ...
     */
    @NonNull
    public Bannerbar setText(@NonNull CharSequence text) {
     ...
     */
    @NonNull
    public Bannerbar setText(@StringRes int resId) {
     ...
     */
    @NonNull
    public Bannerbar setTextColor(@NonNull ColorStateList tint) {
        final TextView message = getContentLayout().getMessageView();
     ...
     */
    @NonNull
    public Bannerbar setAction(CharSequence text, final View.OnClickListener listener) {
     ...
     */
    @NonNull
    public Bannerbar setAction(@StringRes int resId, View.OnClickListener listener) {
    ...
    /**
     * Sets the text color of the action specified in {@link Bannerbar#setAction(CharSequence, View.OnClickListener)}.
     */
    @NonNull
    public Bannerbar setActionTextColor(@ColorInt int color) {
        final TextView action = getContentLayout().getActionView();
     ...
     */
    @NonNull
    public Bannerbar setActionTextColor(@NonNull ColorStateList tint) {
        final TextView action = getContentLayout().getActionView();
